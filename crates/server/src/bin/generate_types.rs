...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::tasks::CreateTaskRequest::decl(),
        server::routes::tasks::UpdateTaskRequest::decl(),
        ...
        server::routes::forge::branch_templates::BranchTemplateResponse::decl(),
        ...
        forge_extensions_omni::OmniConfig::decl(),
        forge_extensions_omni::RecipientType::decl(),
        forge_extensions_omni::OmniInstance::decl(),
