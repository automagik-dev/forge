...
- Example: Use `mcp__genie__run` with agent "forge" and prompt "[Discovery] Use # .genie/wishes/user-notes-wish.md (archived example). [Implementation] Break into execution groups + commands. [Verification] Emit validation hooks and evidence paths."
...
- Example: Use `mcp__genie__run` with agent "review" and prompt "[Discovery] Use # .genie/wishes/user-notes-wish.md (archived example) and execution evidence. [Implementation] Replay validation commands. [Verification] Provide QA verdict + remaining risks."
