...
const ArchiveTaskDialog =
  NiceModal.create<ArchiveTaskDialogProps>(({ task }) => {
      ...
      >
        <DialogContent>
          ...
          <Alert variant="default" className="mb-4">
            <strong>Note:</strong> Archived tasks are moved to the Archive column and hidden from the main workflow.
          </Alert>
