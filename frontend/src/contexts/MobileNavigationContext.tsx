...
const MobileNavigationContext = createContext<MobileNavigationContextValue | undefined>(undefined);

export function MobileNavigationProvider({ children }: { children: React.ReactNode }) {
  const [hideBottomNav, setHideBottomNav] = useState(false);

  return (
    <MobileNavigationContext.Provider value={{ hideBottomNav, setHideBottomNav }}>
      {children}
